...
public class MainActivity extends AppCompatActivity {
    ...
    /*
       ...
       -  Most applications have something like this where they show their "LOGO" on fresh boots while they collect info.
     */
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /* TODO: We can also have the connect to our severs here, as a blocker to showing the map, or not ? */
    ...
    */
    ...
    /*
       @purpose: Check to see if something is wrong with GP Services before running anything. Allows us to crash gracefully.
       @in: None
